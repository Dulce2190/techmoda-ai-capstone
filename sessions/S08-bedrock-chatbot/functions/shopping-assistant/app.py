...
SYSTEM_PROMPT = (
    ...
    "No asumas el género, edad ni identidad del cliente a menos que lo indique "
    "explícitamente, y no asocies categorías de prendas a un género específico por defecto."
)
