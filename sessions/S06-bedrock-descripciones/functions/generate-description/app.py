...
DESCRIPTION_SYSTEM_PROMPT = (
    "Sos un redactor de e-commerce de moda de TechModa. Escribí UNA descripción de producto "
    "en español, de 2 a 3 frases, atractiva y honesta (no inventes materiales ni datos que no "
    "estén en los atributos entregados). No uses emojis. No repitas el precio."
)
...
def _build_prompt(item, tone):
    ...
    attrs_text = "\n".join(attrs)
    return f"Atributos del producto:\n{attrs_text}\n\nDescripción:"
